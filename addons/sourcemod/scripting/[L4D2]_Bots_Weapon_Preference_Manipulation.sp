...
{
	CreateConVar("sm_bots_weapon_preferences_manipulation_version", PLUGIN_VERSION, "[L4D2] Bots Weapon preferences manipulation Version", FCVAR_NONE | FCVAR_SPONLY | FCVAR_REPLICATED | FCVAR_NOTIFY);
	...
	SetRestrictions();
	AutoExecConfig(false, "l4d2_bots_weapon_preferences_manipulation");
}
...
{
	// coach
	new Handle:CoachPistols = CreateConVar("coach_enable_pistols", "1", "Can Coach use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachPistols, ConVarCoachPistols);
	CoachCanUsePistol = GetConVarBool(CoachPistols);
	
	new Handle:CoachMagnums = CreateConVar("coach_enable_magnums", "1", "Can Coach use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachMagnums, ConVarCoachMagnums);
	CoachCanUseMagnum = GetConVarBool(CoachMagnums);
	
	new Handle:CoachT1Shotguns = CreateConVar("coach_enable_t1_shotguns", "1", "Can Coach use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachT1Shotguns, ConVarCoachT1Shotguns);
	CoachCanUseT2Shotgun = GetConVarBool(CoachT1Shotguns);
	
	new Handle:CoachT2Shotguns = CreateConVar("coach_enable_t2_shotguns", "0", "Can Coach use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachT2Shotguns, ConVarCoachT2Shotguns);
	CoachCanUseT2Shotgun = GetConVarBool(CoachT2Shotguns);
	
	new Handle:CoachSMG = CreateConVar("coach_enable_smgs", "1", "Can Coach use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachSMG, ConVarCoachSMG);
	CoachCanUseSMG = GetConVarBool(CoachSMG);
	
	new Handle:CoachSnipers = CreateConVar("coach_enable_snipers", "0", "Can Coach use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachSnipers, ConVarCoachSnipers);
	CoachCanUseSniper = GetConVarBool(CoachSnipers);
	
	new Handle:CoachAssaultRifles = CreateConVar("coach_enable_assault_rifles", "0", "Can Coach use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(CoachAssaultRifles, ConVarCoachAssaultRifles);
	CoachCanUseAssaultRifle = GetConVarBool(CoachAssaultRifles);
	
	
	// ellis
	new Handle:EllisPistols = CreateConVar("ellis_enable_pistols", "1", "Can Ellis use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisPistols, ConVarEllisPistols);
	EllisCanUsePistol = GetConVarBool(EllisPistols);
	
	new Handle:EllisMagnums = CreateConVar("ellis_enable_magnums", "1", "Can Ellis use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisMagnums, ConVarEllisMagnums);
	EllisCanUseMagnum = GetConVarBool(EllisMagnums);
	
	new Handle:EllisT1Shotguns = CreateConVar("ellis_enable_t1_shotguns", "1", "Can Ellis use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisT1Shotguns, ConVarEllisT1Shotguns);
	EllisCanUseT2Shotgun = GetConVarBool(EllisT1Shotguns);
	
	new Handle:EllisT2Shotguns = CreateConVar("ellis_enable_t2_shotguns", "0", "Can Ellis use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisT2Shotguns, ConVarEllisT2Shotguns);
	EllisCanUseT2Shotgun = GetConVarBool(EllisT2Shotguns);
	
	new Handle:EllisSMG = CreateConVar("ellis_enable_smgs", "1", "Can Ellis use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisSMG, ConVarEllisSMG);
	EllisCanUseSMG = GetConVarBool(EllisSMG);
	
	new Handle:EllisSnipers = CreateConVar("ellis_enable_snipers", "0", "Can Ellis use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisSnipers, ConVarEllisSnipers);
	EllisCanUseSniper = GetConVarBool(EllisSnipers);
	
	new Handle:EllisAssaultRifles = CreateConVar("ellis_enable_assault_rifles", "0", "Can Ellis use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(EllisAssaultRifles, ConVarEllisAssaultRifles);
	EllisCanUseAssaultRifle = GetConVarBool(EllisAssaultRifles);
	
	
	// Rochelle
	new Handle:RochellePistols = CreateConVar("rochelle_enable_pistols", "1", "Can Rochelle use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(RochellePistols, ConVarRochellePistols);
	RochelleCanUsePistol = GetConVarBool(RochellePistols);
	
	new Handle:RochelleMagnums = CreateConVar("rochelle_enable_magnums", "1", "Can Rochelle use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(RochelleMagnums, ConVarRochelleMagnums);
	RochelleCanUseMagnum = GetConVarBool(RochelleMagnums);
	
	new Handle:RochelleT1Shotguns = CreateConVar("rochelle_enable_t1_shotguns", "1", "Can Rochelle use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(RochelleT1Shotguns, ConVarRochelleT1Shotguns);
	RochelleCanUseT2Shotgun = GetConVarBool(RochelleT1Shotguns);
	
	new Handle:RochelleT2Shotguns = CreateConVar("rochelle_enable_t2_shotguns", "0", "Can Rochelle use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(RochelleT2Shotguns, ConVarRochelleT2Shotguns);
	RochelleCanUseT2Shotgun = GetConVarBool(RochelleT2Shotguns);
	
	new Handle:RochelleSMG = CreateConVar("rochelle_enable_smgs", "1", "Can Rochelle use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(RochelleSMG, ConVarRochelleSMG);
	RochelleCanUseSMG = GetConVarBool(RochelleSMG);
	
	new Handle:RochelleSnipers = CreateConVar("rochelle_enable_snipers", "0", "Can Rochelle use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(RochelleSnipers, ConVarRochelleSnipers);
	RochelleCanUseSniper = GetConVarBool(RochelleSnipers);
	
	new Handle:RochelleAssaultRifles = CreateConVar("rochelle_enable_assault_rifles", "0", "Can Rochelle use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	...
	// Nick
	new Handle:NickPistols = CreateConVar("nick_enable_pistols", "1", "Can Nick use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickPistols, ConVarNickPistols);
	NickCanUsePistol = GetConVarBool(NickPistols);
	
	new Handle:NickMagnums = CreateConVar("nick_enable_magnums", "1", "Can Nick use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickMagnums, ConVarNickMagnums);
	NickCanUseMagnum = GetConVarBool(NickMagnums);
	
	new Handle:NickT1Shotguns = CreateConVar("nick_enable_t1_shotguns", "1", "Can Nick use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickT1Shotguns, ConVarNickT1Shotguns);
	NickCanUseT2Shotgun = GetConVarBool(NickT1Shotguns);
	
	new Handle:NickT2Shotguns = CreateConVar("nick_enable_t2_shotguns", "0", "Can Nick use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickT2Shotguns, ConVarNickT2Shotguns);
	NickCanUseT2Shotgun = GetConVarBool(NickT2Shotguns);
	
	new Handle:NickSMG = CreateConVar("nick_enable_smgs", "1", "Can Nick use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickSMG, ConVarNickSMG);
	NickCanUseSMG = GetConVarBool(NickSMG);
	
	new Handle:NickSnipers = CreateConVar("nick_enable_snipers", "0", "Can Nick use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickSnipers, ConVarNickSnipers);
	NickCanUseSniper = GetConVarBool(NickSnipers);
	
	new Handle:NickAssaultRifles = CreateConVar("nick_enable_assault_rifles", "0", "Can Nick use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(NickAssaultRifles, ConVarNickAssaultRifles);
	NickCanUseAssaultRifle = GetConVarBool(NickAssaultRifles);
	
	// Bill
	new Handle:BillPistols = CreateConVar("bill_enable_pistols", "1", "Can Bill use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillPistols, ConVarBillPistols);
	BillCanUsePistol = GetConVarBool(BillPistols);
	
	new Handle:BillMagnums = CreateConVar("bill_enable_magnums", "1", "Can Bill use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillMagnums, ConVarBillMagnums);
	BillCanUseMagnum = GetConVarBool(BillMagnums);
	
	new Handle:BillT1Shotguns = CreateConVar("bill_enable_t1_shotguns", "1", "Can Bill use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillT1Shotguns, ConVarBillT1Shotguns);
	BillCanUseT2Shotgun = GetConVarBool(BillT1Shotguns);
	
	new Handle:BillT2Shotguns = CreateConVar("bill_enable_t2_shotguns", "0", "Can Bill use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillT2Shotguns, ConVarBillT2Shotguns);
	BillCanUseT2Shotgun = GetConVarBool(BillT2Shotguns);
	
	new Handle:BillSMG = CreateConVar("bill_enable_smgs", "1", "Can Bill use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillSMG, ConVarBillSMG);
	BillCanUseSMG = GetConVarBool(BillSMG);
	
	new Handle:BillSnipers = CreateConVar("bill_enable_snipers", "0", "Can Bill use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillSnipers, ConVarBillSnipers);
	BillCanUseSniper = GetConVarBool(BillSnipers);
	
	new Handle:BillAssaultRifles = CreateConVar("bill_enable_assault_rifles", "0", "Can Bill use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(BillAssaultRifles, ConVarBillAssaultRifles);
	BillCanUseAssaultRifle = GetConVarBool(BillAssaultRifles);
	
	
	// Francis
	new Handle:FrancisPistols = CreateConVar("francis_enable_pistols", "1", "Can Francis use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(FrancisPistols, ConVarFrancisPistols);
	FrancisCanUsePistol = GetConVarBool(FrancisPistols);
	
	new Handle:FrancisMagnums = CreateConVar("francis_enable_magnums", "1", "Can Francis use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(FrancisMagnums, ConVarFrancisMagnums);
	FrancisCanUseMagnum = GetConVarBool(FrancisMagnums);
	
	new Handle:FrancisT1Shotguns = CreateConVar("francis_enable_t1_shotguns", "1", "Can Francis use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(FrancisT1Shotguns, ConVarFrancisT1Shotguns);
	FrancisCanUseT2Shotgun = GetConVarBool(FrancisT1Shotguns);
	
	new Handle:FrancisT2Shotguns = CreateConVar("francis_enable_t2_shotguns", "0", "Can Francis use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(FrancisT2Shotguns, ConVarFrancisT2Shotguns);
	FrancisCanUseT2Shotgun = GetConVarBool(FrancisT2Shotguns);
	
	new Handle:FrancisSMG = CreateConVar("francis_enable_smgs", "1", "Can Francis use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(FrancisSMG, ConVarFrancisSMG);
	FrancisCanUseSMG = GetConVarBool(FrancisSMG);
	
	new Handle:FrancisSnipers = CreateConVar("francis_enable_snipers", "0", "Can Francis use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(FrancisSnipers, ConVarFrancisSnipers);
	FrancisCanUseSniper = GetConVarBool(FrancisSnipers);
	
	new Handle:FrancisAssaultRifles = CreateConVar("francis_enable_assault_rifles", "0", "Can Francis use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	...
	// Louis
	new Handle:LouisPistols = CreateConVar("louis_enable_pistols", "1", "Can Louis use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisPistols, ConVarLouisPistols);
	LouisCanUsePistol = GetConVarBool(LouisPistols);
	
	new Handle:LouisMagnums = CreateConVar("louis_enable_magnums", "1", "Can Louis use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisMagnums, ConVarLouisMagnums);
	LouisCanUseMagnum = GetConVarBool(LouisMagnums);
	
	new Handle:LouisT1Shotguns = CreateConVar("louis_enable_t1_shotguns", "1", "Can Louis use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisT1Shotguns, ConVarLouisT1Shotguns);
	LouisCanUseT2Shotgun = GetConVarBool(LouisT1Shotguns);
	
	new Handle:LouisT2Shotguns = CreateConVar("louis_enable_t2_shotguns", "0", "Can Louis use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisT2Shotguns, ConVarLouisT2Shotguns);
	LouisCanUseT2Shotgun = GetConVarBool(LouisT2Shotguns);
	
	new Handle:LouisSMG = CreateConVar("louis_enable_smgs", "1", "Can Louis use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisSMG, ConVarLouisSMG);
	LouisCanUseSMG = GetConVarBool(LouisSMG);
	
	new Handle:LouisSnipers = CreateConVar("louis_enable_snipers", "0", "Can Louis use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisSnipers, ConVarLouisSnipers);
	LouisCanUseSniper = GetConVarBool(LouisSnipers);
	
	new Handle:LouisAssaultRifles = CreateConVar("louis_enable_assault_rifles", "0", "Can Louis use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(LouisAssaultRifles, ConVarLouisAssaultRifles);
	LouisCanUseAssaultRifle = GetConVarBool(LouisAssaultRifles);
	
	
	// Zoey
	new Handle:ZoeyPistols = CreateConVar("zoey_enable_pistols", "1", "Can Zoey use pistols? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeyPistols, ConVarZoeyPistols);
	ZoeyCanUsePistol = GetConVarBool(ZoeyPistols);
	
	new Handle:ZoeyMagnums = CreateConVar("zoey_enable_magnums", "1", "Can Zoey use magnums? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeyMagnums, ConVarZoeyMagnums);
	ZoeyCanUseMagnum = GetConVarBool(ZoeyMagnums);
	
	new Handle:ZoeyT1Shotguns = CreateConVar("zoey_enable_t1_shotguns", "1", "Can Zoey use t1 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeyT1Shotguns, ConVarZoeyT1Shotguns);
	ZoeyCanUseT2Shotgun = GetConVarBool(ZoeyT1Shotguns);
	
	new Handle:ZoeyT2Shotguns = CreateConVar("zoey_enable_t2_shotguns", "0", "Can Zoey use t2 shotguns? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeyT2Shotguns, ConVarZoeyT2Shotguns);
	ZoeyCanUseT2Shotgun = GetConVarBool(ZoeyT2Shotguns);
	
	new Handle:ZoeySMG = CreateConVar("zoey_enable_smgs", "1", "Can Zoey use smgs? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeySMG, ConVarZoeySMG);
	ZoeyCanUseSMG = GetConVarBool(ZoeySMG);
	
	new Handle:ZoeySnipers = CreateConVar("zoey_enable_snipers", "0", "Can Zoey use snipers? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeySnipers, ConVarZoeySnipers);
	ZoeyCanUseSniper = GetConVarBool(ZoeySnipers);
	
	new Handle:ZoeyAssaultRifles = CreateConVar("zoey_enable_assault_rifles", "0", "Can Zoey use assault rifles? (0 = No, 1 = Yes)", FCVAR_NONE, true, 0.0, true, 1.0);
	HookConVarChange(ZoeyAssaultRifles, ConVarZoeyAssaultRifles);
	ZoeyCanUseAssaultRifle = GetConVarBool(ZoeyAssaultRifles);
	
	// Restriction Type
	new Handle:Restrictions = CreateConVar("restriction_type", "1", "What kind of restrictions will be applied to disabled weapons? (0 = Bots may pick up disabled weapons when it is their only choice, 1 = Bots will NEVER pick up restricted weapons)", FCVAR_NONE, true, 0.0, true, 1.0);
